...
```go
import "github.com/a2y-d5l/ci/multiproc/engine"
...
```go
import "github.com/a2y-d5l/ci/multiproc/runner"
...
```bash
go doc github.com/a2y-d5l/ci/multiproc/runner
go doc github.com/a2y-d5l/ci/multiproc/engine
go doc github.com/a2y-d5l/ci/multiproc/renderer
```

Or online at [pkg.go.dev](https://pkg.go.dev/github.com/a2y-d5l/ci/multiproc).
