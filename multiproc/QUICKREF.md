...
```bash
go get github.com/a2y-d5l/ci/multiproc
```
...
import (
    ...
    "github.com/a2y-d5l/ci/multiproc/runner"
)
...
```go
import (
    "github.com/a2y-d5l/ci/multiproc/engine"   // Direct engine usage
    "github.com/a2y-d5l/ci/multiproc/renderer" // Custom rendering
    "github.com/a2y-d5l/ci/multiproc/runner"   // Simple usage
)
```
...
- API docs: `go doc github.com/a2y-d5l/ci/multiproc/runner`
...
- Issues: <https://github.com/a2y-d5l/ci/issues>
- Docs: <https://pkg.go.dev/github.com/a2y-d5l/ci/multiproc>
